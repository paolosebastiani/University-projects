...
regression1 = evaluate_model(:INDPRO, [:CPIAUCSL, :TB3MS, :AWHMAN])
println(regression1)
regression2 = evaluate_model(:CPIAUCSL, [:M1SL, :UNRATE, :FEDFUNDS, :OILPRICEx])
println(regression2)
regression3 = evaluate_model(:FEDFUNDS, [:CPIAUCSL, :UNRATE, :INDPRO, :TB3MS, :INVEST, :DTCTHFNM, :NONREVSL, :PCEPI])
println(regression3)